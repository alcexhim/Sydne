...
<?php
	...
	class SaleModifyPage extends SydnePage
	{
		...
		protected function AfterVariablesInitialize()
		{
			...
			if (!$this->IsVariableSet("CustomerPaymentAmount"))
			{
				...
				{
					$this->ToolbarRightItems[] = new ButtonGroupButton("btngCancelSale", "Cancel Sale", null, "~/Images/Buttons/Cancel.png", "~/Sales/Create");
				}
			}
			else
			{
				$this->ToolbarRightItems[] = new ButtonGroupButton("btngNewSale", "New Sale", null, "~/Images/Buttons/SaleCreate.png", "~/Sales/Create");
	...
	System::$Modules["Sydne.DefaultModule"]->Pages[] = new ModulePage("Sales", function($path)
	{
